            ...
            <form method="POST" action="{{route('cubic_spline_method')}}" class="form">
                ...
                @if($data["storage"] == "true")
                    <div class="text-align">
                        ...
                        <a class="btn btn-outline-primary btn-block" href="{{ route('cubicSpline') }}">Try with another arrays</a>
                    </div>
                @else
                <div class="form-row">
                    <div class="form-group col-md-12">
        ...
        @if ($data["checkMem"] == "true" and $data["mem"][2][0] != 0)
            <div class="col-md-6" style="float: right;">
                ...
                @for($j = 1; $j < count($data["mem"][2]); $j++)
                    <a class="btn btn-outline-primary btn-sm" href="{{ route('storage_cubic_spline',['storage'=> $j,'method' => 2]) }}">Use Storage {{$j}}</a> <br><br>
                    $$x = \begin{bmatrix}
