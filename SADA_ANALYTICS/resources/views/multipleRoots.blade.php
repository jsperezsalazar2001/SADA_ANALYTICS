    ...
    <div class="row justify-content-center">
        <div class="col-md-6" style="float: left;">
                    ...
                    @if($data["storage"] == "true")
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" placeholder="{{ __('multiple_roots.input.iterations') }}" value="{{ empty($data['iterations']) ? '' : $data['iterations'] }}" name="iterations" step="1" min="1" max="200" required />
                            </div>
                        </div>
                        <div class="form-row">
            ...
            <div class="row">
                ...
                @endif
                @if (!empty($data["d2f_function"]))
                <div class="col-md-4">
                    <form method="POST" action="{{ route('function_plotter_url') }}" class="form" target="_blank">
                        @csrf    
                        <input type="hidden" name="f_function" value="{{ $data['d2f_function'] }}">
                        <button type="submit" class="btn btn-info btn-block">Graph f''(x)</button>
                    </form>
                </div>
                @endif
